...
export function SearchView({ allProducts }: Props) {
  ...
  return (
    <PageShell>
      ...
      <div className="px-4 pt-2 pb-4 space-y-4">
        <div className="flex h-12 w-full items-center gap-2 rounded-2xl bg-ink-100 px-4 text-[14px] text-ink-700 focus-within:bg-white focus-within:ring-2 focus-within:ring-brand-200">
